...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://repl.it/@AslamOP/generatestringsession
    ...
    # set this with required aslam repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/AslamOP/AslamOP_userbot.git copy it and past"
    )
